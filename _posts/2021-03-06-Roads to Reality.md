...
물론 그렇다고 해서 인플레이션 우주론이 완벽하다고 할 수는 없다. 일반 상대성 이론을 기초하고 있는 인플리에션 우주론에 양자역학적 관점으로 본다면 모순이 생긴다고 한다. 20년 동안 믿어 왔던 이론의 큰 모순은 이론 물리학자들에게는 악몽 그 자체였다고 한다. 이 모순에 대한 접근을 위해 대두 된 것이 바로 통이랒ㅇ$$_\text{unified theory}$$이다.
